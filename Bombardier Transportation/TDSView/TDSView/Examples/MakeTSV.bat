...
echo ---------------------------------------------------------------------------
echo.
echo  Convert ED_V files into TSV files; Created 05.12.2013 by Bos, PPC Zuerich
echo.
echo ---------------------------------------------------------------------------
echo.
...
rem    the directory path to the ED_D files, the output directory
rem    and filter parameter: See TDSView Help
echo %TDSVIEWEXE% /TSV /L=DE %%1 D:\MAVIS /ENV>> dummy.bat
rem ******************************************************************
